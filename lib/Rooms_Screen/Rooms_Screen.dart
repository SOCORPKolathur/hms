...
class Rooms_Screen extends StatefulWidget {
  const Rooms_Screen({super.key});

  @override
  State<Rooms_Screen> createState() => _Rooms_ScreenState();
}
...
class _Rooms_ScreenState extends State<Rooms_Screen> {
  ...
  TextEditingController RoomnameContoller=TextEditingController();
              ...
              children: [
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width:width/1.26,
                    child: StreamBuilder(
                      stream: FirebaseFirestore.instance.collection("Rooms").orderBy("timestamp").snapshots(),
          ...
          if (item == "Edit") {
            ...
            CoolAlert.show(
                ...
                onConfirmBtnTap: () async {
                  FirebaseFirestore.instance.collection("Rooms").doc(DocumentID).delete();
                });
          }
        },
        value: item,
